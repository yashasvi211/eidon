      ...
      >
        <div
          ...
          style={{
            ...
            borderRadius: "7px",
            cursor: "pointer",
            color: isSleeping ? "var(--gh-blue)" : "var(--gh-muted)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            transition: "all 0.15s",
            background: isSleeping ? "rgba(88, 166, 255, 0.1)" : "transparent",
            border: isSleeping ? "1px solid var(--gh-blue)" : "1px solid transparent",
          }}
          title={isSleeping ? "Wake Up" : "Start Sleep"}
        >
          <svg
            width="18"
            height="18"
